...
public class ModelSpider extends ModelBase {
    ...
    public ModelSpider() {
        ...
        field_1255_a.setPosition(0.0F, i, -3F);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        field_1250_f.rotateAngleY = f8 + f7;
        field_1249_g.rotateAngleY = -f8 - f7;
        field_1248_h.rotateAngleY = -f8 + f7;
        field_1247_i.rotateAngleY = f8 - f7;
