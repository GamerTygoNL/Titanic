    ...
    public void func_783_a() {
        for (int i = 0; i < 16; i++) {
            for (int j = 0; j < 16; j++) {
                ...
                field_1146_h[i + j * 16] = f / 10F + ((field_1145_i[(i & 0xf) + (j & 0xf) * 16] + field_1145_i[(i + 1 & 0xf) + (j & 0xf) * 16] + field_1145_i[(i + 1 & 0xf) + (j + 1 & 0xf) * 16] + field_1145_i[(i & 0xf) + (j + 1 & 0xf) * 16]) / 4F) * 0.8F;
